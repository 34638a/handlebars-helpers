...
/**
 * Min of number `a` and number `b`.
 *
 * @param {Number} `a` value 1
 * @param {Number} `b` value 2
 * @return {Number} `a` or `b` dependant on which is smaller.
 * @api public
 */
...
/**
 * Max of number `a` and number `b`.
 *
 * @param {Number} `a` value 1
 * @param {Number} `b` value 2
 * @return {Number} `a` or `b` dependant on which is larger.
 * @api public
 */
